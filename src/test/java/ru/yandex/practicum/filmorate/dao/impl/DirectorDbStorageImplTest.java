...
public class DirectorDbStorageImplTest {
    ...
    public void findAllTest() {
        ...
        directorStorage.createDirector(new Director(1, "Ivanov"));
        assertEquals(1, directorStorage.findAll().size());
        directorStorage.createDirector(new Director(2, "Petrov"));
    ...
    public void putTest() {
        directorStorage.createDirector(new Director(1, "Ivanov"));
        directorStorage.updateDirector(new Director(1, "Petrov"));
        assertEquals("Petrov", directorStorage.findDirectorById(1).getName());
    }

    @Test
    public void delDirectorByIdTest() {
        System.out.println("Director: " + directorStorage.createDirector(new Director(1, "Ivanov")));
