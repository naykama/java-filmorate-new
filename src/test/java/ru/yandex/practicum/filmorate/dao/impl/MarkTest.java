...
public class MarkTest {
    ...
    private void createContext() {
        ...
        Film film2 = new Film(2, "film2", "filmDescr", LocalDate.now(), 30);
        film2.setMpa(new Mpa(1, "G"));
        filmService.post(film2);
        Film film3 = new Film(3, "film3", "filmDescr", LocalDate.now(), 30);
        film3.setMpa(new Mpa(1, "G"));
        filmService.post(film3);
        Film film4 = new Film(4, "film4", "filmDescr", LocalDate.now(), 30);
